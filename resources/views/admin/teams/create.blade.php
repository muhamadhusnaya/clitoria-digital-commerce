<x-app-layout>
 ...
 <h2 class="text-headline-md text-[32px] font-bold text-[#151936]">Tambah Anggota Baru</h2>
 <p class="text-[#797584] mt-1">Tambahkan profesional baru ke galeri tim inti Anda.</p>
 </div>
 ...
 <input name="name" value="{{ old('name') }}" required class="w-full h-[56px] rounded-xl border-none bg-[#f4f2ff] px-5 input-focus-ring text-body-md transition-all placeholder:text-outline/70" placeholder="mis. dr. Julianne Reed" type="text">
 </div>
 <div class="space-y-2">
 <label class="text-label-md font-semibold text-[#797584] ml-1">Posisi/Peran <span class="text-[#ba1a1a]">*</span></label>
 <input name="position" value="{{ old('position') }}" required class="w-full h-[56px] rounded-xl border-none bg-[#f4f2ff] px-5 input-focus-ring text-body-md transition-all placeholder:text-outline/70" placeholder="mis. Ahli Botani" type="text">
 </div>
 </div>
 ...
 <input name="instagram" value="{{ old('instagram') }}" class="w-full h-[56px] rounded-xl border-none bg-[#f4f2ff] pl-12 pr-5 input-focus-ring text-body-md transition-all placeholder:text-outline/70" placeholder="instagram.com/akun" type="url">
 </div>
 </div>
 <div class="space-y-2">
 ...
 <input name="linkedin" value="{{ old('linkedin') }}" class="w-full h-[56px] rounded-xl border-none bg-[#f4f2ff] pl-12 pr-5 input-focus-ring text-body-md transition-all placeholder:text-outline/70" placeholder="linkedin.com/in/akun" type="url">
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 class="text-lg font-bold text-center mb-6">Foto Profil <span class="text-[#ba1a1a]">*</span></h3>
 ...
 <input type="file" name="photo" id="photo-upload" class="hidden" accept="image/*" required onchange="previewImage(this)">
 ...
 Gunakan foto potret berkualitas tinggi dengan latar belakang bersih atau senada untuk menjaga konsistensi.
 </p>
 </div>
 </div>
 </div>
