            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div class="md:col-span-7 flex flex-col gap-8">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input name="order_number" type="number" value="{{ old('order_number', 0) }}" class="h-[56px] px-6 rounded-xl border-0 bg-[#f4f2ff] focus:ring-2 focus:ring-[#432b9f] focus:bg-white shadow-sm transition-all duration-300 text-[16px]" id="order_number" />
                    </div>
                </div>
