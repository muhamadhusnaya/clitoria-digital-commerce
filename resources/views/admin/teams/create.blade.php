                    ...
                    <form action="{{ route('admin.teams.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="e.g. Jane Doe">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="position" id="position" value="{{ old('position') }}" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="e.g. Master Brewer">
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="instagram" id="instagram" value="{{ old('instagram') }}" class="w-full pl-10 bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="https://instagram.com/...">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="url" name="linkedin" id="linkedin" value="{{ old('linkedin') }}" class="w-full pl-10 bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="https://linkedin.com/in/...">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Right Column: Photo -->
                            <div>
                                <label class="block text-sm font-medium text-[#151936] dark:text-gray-200 mb-1">Professional Photo <span class="text-[#BA1A1A]">*</span></label>
                                    ...
                                    <div class="space-y-2 text-center relative z-10 flex flex-col justify-center" id="upload-prompt">
                                        ...
                                        <div class="flex text-sm text-gray-600 dark:text-gray-300 justify-center">
                                            <label for="photo" class="relative cursor-pointer rounded-md font-medium text-[#432B9F] hover:text-[#5B46B8] focus-within:outline-none">
                                                ...
                                                <input id="photo" name="photo" type="file" class="sr-only" required accept="image/jpeg, image/png, image/jpg, image/webp">
                                            </label>
                        ...
                        <div class="mt-8 pt-5 border-t border-[#C9C4D5] dark:border-gray-700 flex justify-end">
                            <button type="submit" class="px-6 py-3 bg-[#432B9F] text-white rounded-full font-medium hover:bg-[#5B46B8] transition-all shadow-md flex items-center gap-2">
                                <span class="material-symbols-outlined text-sm">save</span> Save Member
                            </button>
                        </div>
                    </form>
