    ...
    <div class="max-w-[1280px] mx-auto px-6 lg:px-16">
        ...
        <div class="relative max-w-3xl mx-auto pb-16" x-data="{ 
            ...
            <div class="relative w-full" x-ref="container" style="transition: height 0.3s ease;">
                ...
                <div class="t-card absolute left-1/2 top-0 flex flex-col justify-center gap-6 bg-white p-6 md:p-10 rounded-xl soft-shadow text-center transition-all duration-500 ease-in-out cursor-pointer" style="width: 100%; max-width: 560px;"
                     :class="{
