                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title', $benefit->title) }}" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none">
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="icon" id="icon" value="{{ old('icon', $benefit->icon) }}" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 pl-12 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none font-mono text-sm">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="order_number" id="order_number" value="{{ old('order_number', $benefit->order_number) }}" class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none">
                                </div>
                            </div>
                        </div>
