                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $partner->name) }}" required
                                    class="w-full h-[56px] px-4 rounded-xl border-outline-variant bg-surface-container-lowest focus:border-primary focus:ring focus:ring-primary/20 transition-all">
                    ...
                    <div class="space-y-6">
                        <div class="bg-surface-container-lowest p-6 rounded-2xl shadow-[0_10px_30px_-10px_rgba(31,35,64,0.04)] border border-outline-variant/30">
                            <label class="block text-sm font-medium text-on-surface mb-4">Partner Logo</label>
                            ...
                            <div class="relative w-full aspect-video rounded-2xl border-2 border-dashed border-outline-variant bg-surface-container hover:bg-surface-container-high transition-colors flex flex-col items-center justify-center cursor-pointer overflow-hidden group mx-auto p-4" onclick="document.getElementById('logo').click()">
                                @if($partner->logo)
                                    <img id="image-preview" src="{{ asset('storage/' . $partner->logo) }}" alt="Preview" class="absolute inset-4 max-w-[calc(100%-2rem)] max-h-[calc(100%-2rem)] object-contain">
                                @else
                            ...
                            <p class="text-xs text-on-surface-variant mt-4 text-center">Leave blank to keep existing logo.</p>
