                    ...
                    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name') }}" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="e.g. John Doe">
                                    </div>
                                    <div>
                                        <label for="occupation" class="block text-sm font-medium text-[#151936] dark:text-gray-200 mb-1">Occupation</label>
                                        <input type="text" name="occupation" id="occupation" value="{{ old('occupation') }}" class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="e.g. CEO at Company">
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-[#151936] dark:text-gray-200 mb-2">Rating <span class="text-[#BA1A1A]">*</span></label>
                                    <div class="flex items-center gap-2 rating-selector" x-data="{ rating: {{ old('rating', 5) }} }">
                                ...
                                <div>
                                    ...
                                    <textarea name="review" id="review" rows="5" required class="w-full bg-[#F4F2FF] dark:bg-[#3E3E3A] border border-[#797584] dark:border-gray-600 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#432B9F] focus:border-[#432B9F] transition-all outline-none" placeholder="Write customer's review here...">{{ old('review') }}</textarea>
                                </div>
                                ...
                                <div>
                                    <label class="flex items-center gap-3 cursor-pointer p-4 border border-[#C9C4D5] dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-[#2C2C2A]">
                                        <div class="relative flex items-center">
                                            <input type="checkbox" name="featured" id="featured" value="1" class="peer sr-only" {{ old('featured') ? 'checked' : '' }}>
                            ...
                            <div class="lg:col-span-1">
                                <label class="block text-sm font-medium text-[#151936] dark:text-gray-200 mb-2">Customer Photo</label>
                                <p class="text-xs text-gray-500 mb-4">Upload a profile picture. If left empty, an initial avatar will be used.</p>
                                ...
                                <div class="mt-1 flex flex-col items-center p-6 border-2 border-[#797584] dark:border-gray-600 border-dashed rounded-xl bg-[#F4F2FF] dark:bg-[#3E3E3A] relative group hover:border-[#432B9F] transition-colors" id="drop-zone">
                                    <div class="space-y-4 text-center relative z-10 w-full" id="upload-prompt">
                                    ...
                                    <!-- Image Preview -->
                                    <div id="image-preview-container" class="hidden absolute inset-0 rounded-xl overflow-hidden bg-black/5 flex flex-col items-center justify-center p-4">
                        ...
                        <div class="mt-8 pt-5 border-t border-[#C9C4D5] dark:border-gray-700 flex justify-end">
                            <button type="submit" class="px-6 py-3 bg-[#432B9F] text-white rounded-full font-medium hover:bg-[#5B46B8] transition-all shadow-md flex items-center gap-2">
                                <span class="material-symbols-outlined text-sm">save</span> Save Testimonial
                            </button>
                        </div>
                    </form>
