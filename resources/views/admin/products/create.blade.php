<x-app-layout>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-2 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="short_description" name="short_description" rows="3" class="block mt-1 w-full border-outline-variant focus:border-primary focus:ring-primary rounded-xl shadow-sm">{{ old('short_description') }}</textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="5" class="block mt-1 w-full border-outline-variant focus:border-primary focus:ring-primary rounded-xl shadow-sm">{{ old('description') }}</textarea>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-surface-container rounded-xl p-4">
                                    <label for="status" class="inline-flex items-center">
                                        <input id="status" type="checkbox" class="rounded border-outline-variant text-primary shadow-sm focus:ring-primary" name="status" value="1" {{ old('status', true) ? 'checked' : '' }}>
    ...
    <script>
        // Simple script to generate slug from name
